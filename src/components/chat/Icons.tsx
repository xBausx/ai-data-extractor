...
// Houses all of our small, reusable SVG icon components.
...
export const UploadIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M21.2 15c.7-1.2 1-2.5.7-3.9-.6-2.4-3.4-4.4-6.2-4.4H10.5c-2.9 0-5.5 2.2-5.5 5.1 0 2.2 1.4 4.1 3.5 4.8" />
